...
|------|-----------|-------------------|------|
| 1차  | 5 epoch, batch size 4, LoRA 적용 | 0.350 → **0.916** (+0.566 ↑) | 응답 품질 대폭 향상, 전문성·일관성 개선 |
| 2차  | 10 epoch, 동일 조건 | 0.916 → **0.914** (-0.002 ↓) | 성능 정체, 과적합 가능성 있음 |
| 3차  | 3 epoch, batch size 2 | 0.350 → **0.891** (+0.541 ↑) | 빠른 수렴, 효율적 학습 가능성 |
